...
def Cadastro(page):
    ...
    def Confirmar_Cadastro(e):
        ...
        if not nome.value:
        ...
        elif (not cpf.value) or (cpf.value == "00000000000"):
            ...
            try:
                if validador_cpf(cpf.value):
                    ...
                    Account.create(email=email.value, usuario=nome.value, saldo=0, cartao=cartao_user, senha=usuario.senha, cpf=cpf.value)
